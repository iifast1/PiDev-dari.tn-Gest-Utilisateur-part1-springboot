...
//	        .passwordEncoder(passwordEncoder());
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("retrieve-user/{user-id}").hasAuthority("ADMIN");
...
//    }
    ...
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:44316/*"));
